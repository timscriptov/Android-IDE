...
public class Constants {
     ...
     */
    public static final String PROJECT_ROOT = Environment.getExternalStorageDirectory().getPath() + File.separator + "AppStudio";
     ...
     * Application package
     */
    static final String PACKAGE = "com.mcal.studio";
}
